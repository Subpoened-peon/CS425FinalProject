        ...
        try:
            ...
            while True:
                ...
                if command == "nick":
                    ...
                    # Check if the client has a nickname set (generated by chatGPT)
                    if not nickname:
                        self.send_object(client_socket, {"type": "error", "data": "You must set a nickname before joining a channel. Use /nick <name>."})
                        continue
                    ...
                    if current_channel == channel_name:
                        self.channels[current_channel].remove_client(client_socket, self)
                    self.channels[channel_name].add_client(client_socket)
